    ...
    <Popover.Root open={isOpen}>
      <div className="relative h-full">
        ...
        >
          ...
          <i className="ri-arrow-down-s-line h-4 w-4" />
        </Popover.Trigger>
        ...
        >
          ...
          {TEXT_COLORS.map(({ name, color }, index) => (
            ...
            >
              ...
              {editor.isActive('textStyle', { color }) && <i className="ri-check-line h-4 w-4" />}
            </button>
          ))}
          ...
          {HIGHLIGHT_COLORS.map(({ name, color }, index) => (
            ...
            >
              ...
              {editor.isActive('highlight', { color }) && <i className="ri-check-line h-4 w-4" />}
            </button>
          ))}
        </Popover.Content>
      </div>
